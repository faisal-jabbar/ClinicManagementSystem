        ...
        <div class="box box-info">
            ...
            <form method="post" action="{{ route('patient_register') }}" class="form-horizontal">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">{{__('CNIC / NIC')}}</label>
                        <div class="col-sm-10">
                            <input type="text" pattern="^[0-9]{5}-?[0-9]{7}-?[0-9]{1}$|^[1-9]{1}[0-9]{8}[V,X,v,x]$|^[0-9]{12,15}$" maxlength="15"
                                class="form-control" name="reg_pnic" placeholder="CNIC (e.g. 37405-1234567-1 or 3740512345671)" title="Pakistani CNIC: 13 digits (e.g. 37405-1234567-1 or 3740512345671)">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">{{__('Telephone')}} <span
                                style="color:red">*</span></label>
                        <div class="col-sm-10">
                            <input pattern="^(\+92|0092|0)?3[0-9]{2}-?[0-9]{7}$|^(\+92|0092|0)?[1-9][0-9]{1,3}-?[0-9]{6,8}$|^[0-9+ -]{10,16}$" required maxlength="16" type="text"
                                class="form-control" name="reg_ptel" placeholder="Patient Phone (e.g. 03001234567 or +923001234567)" title="Pakistani Phone Number (e.g. 03001234567, 0300-1234567, or +923001234567)">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group date">
                                ...
                                <input type="date" required max="{{date('Y-m-d')}}" class="form-control pull-right"
