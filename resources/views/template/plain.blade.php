...
$outlet = 'Pindsultani Medical Hospital';
\App::setLocale('en');
?>
...
<head>
    ...
    <title>Pindsultani Medical Hospital | @yield('title')</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header skin-green">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-mini"><b>P</b>MH</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>Pindsultani</b> Hospital</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{date('Y')}} <a href="#">Pindsultani Medical Hospital</a>.</strong> All rights reserved.
        </footer>
